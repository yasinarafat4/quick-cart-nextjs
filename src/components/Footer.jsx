      ...
      <div className="footer border-t border-base-300 bg-base-200 px-10 py-4 text-base-content">
        ...
        <div className="md:place-self-center md:justify-self-end">
          <div className="grid grid-flow-col gap-4">
            <a href="https://twitter.com/YasinArafat04" target="_blank">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
            ...
            <a
              href="https://www.linkedin.com/in/md-yasin-arafat-hasib4/"
              target="_blank"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
            ...
            <a href="https://www.facebook.com/mdyasinarafat.hasib" target="_blank">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
